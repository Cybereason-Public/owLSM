...
Who is it for: Teams and companies that protect Linux and cloud environments. Developers looking for implementation examples of complex eBPF solutions.

We at @Cybereason decided to open-source this project as we aspire to become the gold standard for prevention and detection on Linux.
We want the community to test it, give us feedback, and hopefully contribute.


# in first comment
https://github.com/Cybereason-Public/owLSM
And while you're there, give us a star {star emoji}
